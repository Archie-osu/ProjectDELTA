...
namespace ImGui
{
    ...
    IMGUI_API bool          CheckboxDouble(const char* label, double* v);
    ...
    IMGUI_API bool          SliderDouble(const char* label, double* v, double v_min, double v_max, const char* format, float power);
